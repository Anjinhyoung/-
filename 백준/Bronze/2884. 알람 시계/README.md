...
### 이 문제를 풀고 난 후
 * 이 문제 두 번 풀었다.
 * 2525번 풀고 난 뒤에 두 번 째 풀이가 생각이 났다.
 * 45분을 뺐을 때 0 분이 지나가면 무조건 15분을 더하는 게 아니라 우리나라 시간을 잘 생각하면 된다.
 * ex) 17시는 17 - 12 = 5 즉 오후 5시가 되는 것처럼 '60'을 기준으로 생각하면 된다.
